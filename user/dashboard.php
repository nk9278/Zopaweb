    ...
    <div class="col-lg-8">
        ...
        <div class="row g-3">
            ...
            $tools = [
                ...
                ['icon' => 'bi-search', 'label' => 'SEO Settings', 'color' => 'dark', 'link' => '/user/seo.php'],
                ...
                ['icon' => 'bi-globe', 'label' => 'Domain', 'color' => 'dark', 'link' => '/user/domains.php'],
                ['icon' => 'bi-rocket-takeoff', 'label' => 'Publish', 'color' => 'success', 'link' => '/user/publish.php'],
            ];
