    ...
    <?php if (empty($pages)): ?>
        <div class="col-12">
            <div class="card border-0 shadow-sm p-5 text-center bg-light">
                ...
                <h4 class="fw-bold">No pages yet</h4>
                <p class="text-muted mb-4">Create your first page to start building your website structure.</p>
                <div>
                    <button type="button" class="btn btn-primary px-4 py-2 fw-bold" data-bs-toggle="modal" data-bs-target="#addPageModal">
